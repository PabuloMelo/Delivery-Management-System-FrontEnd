...
class LoadValidateController {
    ...
    private fun findOrdersByLoad() {
        ...
        val driverFinded = loadResource.findDriverByName(driverName)
    ...
    private fun findLoadByLoadCode(): Load {
        ...
        val loadFinded = loadResource.findLoadByLoadCode(loadCode)

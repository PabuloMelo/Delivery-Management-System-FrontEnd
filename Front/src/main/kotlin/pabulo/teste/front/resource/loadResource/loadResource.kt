...
class LoadResource {
    ...
    private val urlLocalDb =
        "jdbc:sqlite:C:/Users/USUARIO/Desktop/ProjectFront/Front/src/main/resources/pabulo/teste/front/DB/deliverySystemDb.db"
    ...
    fun getDrivers(): List<String> {
        ...
        val resultSet = statement.executeQuery("SELECT driver_Name FROM motoristas")
